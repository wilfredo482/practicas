...
exports.default = exports.DEFAULT_SLOW_VERIFY_MS = exports.DEFAULT_BCRYPT_ROUNDS = void 0;
  ...
  adduser(user, password, realCb) {
    ...
    (0, _utils.sanityCheck)(user, password, _utils.verifyPassword, this.users, this.maxUsers).then(sanity => {
      ...
      (0, _utils.lockAndRead)(pathPass, async (err, res) => {
        ...
        try {
          this._writeFile((0, _utils.addUserToHTPasswd)(body, user, password, this.hashConfig), cb);
        } catch (err) {
          return cb(err);
        }
      });
