...
export declare const generatePersistedFunctionsSource: (netlifyGraphConfig: NetlifyGraphConfig, netlifyJwt: string, siteId: string, schema: GraphQLSchema, operationsDoc: string, queries: Record<string, PersistedFunction>, fragments: Record<string, ExtractedFragment>, schemaId: string) => Promise<{
    clientSource: string;
    typeDefinitionsSource: string;
    functionDefinitions: ParsedFunction[];
