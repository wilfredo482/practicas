...
export declare const gatherHardcodedValues: (query: string) => [string, string | number][];
export declare const extractPersistableOperation: (doc: DocumentNode, operationDefinition: OperationDefinitionNode) => string | null;
export {};
