...
var fragmentToParsedFragmentDefinition = function (currentFragments, fullSchema, persistedQuery) {
    var basicFn = {
        id: persistedQuery.id,
        operationString: persistedQuery.operationString,
        description: persistedQuery.description || "",
    ...
    var returnSignature = (0, graphqlHelpers_1.typeScriptSignatureForFragment)(fullSchema, operation, __assign(__assign({}, currentFragments), fragments));
    var variableNames = (operation.variableDefinitions || []).map(function (varDef) { return varDef.variable.name.value; });
...
var generateFunctionsSource = function (netlifyGraphConfig, schema, operationsDoc, queries, fragments) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        fragmentDefinitions = Object.entries(fragments).reduce(function (_a, _b) {
            ...
            var parsed = (0, exports.fragmentToParsedFragmentDefinition)(fragmentNodes, schema, fragment);
            return {
...
var generatePersistedFunctionsSource = function (netlifyGraphConfig, netlifyJwt, siteId, schema, operationsDoc, queries, fragments, schemaId) { return __awaiter(void 0, void 0, void 0, function () {
